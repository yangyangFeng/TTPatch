...
//                        JP_DEFINE_TYPE_SIGNATURE(void *);
//                    }
//                    NSArray *lt = [[blockDic objectForKey:@"__className"] componentsSeparatedByString:@","];
...
//
//
//                    NSMethodSignature *signature = [NSMethodSignature signatureWithObjCTypes:[funcSignature cStringUsingEncoding:NSUTF8StringEncoding]];
...
//                            JP_HOOK_METHOD(@selector(forwardInvocation:), OC_MSG_SEND_HANDLE_ID);
//                        });
//
...
//                            //                        NSObject* result = dynamic_cast<NSObject*>(arg0);
//                            int arg11 = arg0;
//                            [tempArguments addObject:(id)CFBridgingRelease(arg0)];
//                            va_list argList;
//                            va_start(argList, arg0);
//                            for (int i = 0; i < systemMethodArgCount; i++) {
//                                void * tempArg = va_arg(argList, void *);
//                                int arg11 = tempArg;
//                                //                                [tempArguments addObject:(id)CFBridgingRelease(tempArg)];
//                                //                                [tempArguments addObject:[NSValue valueWithPointer:tempArg]];
//                            }
//                            va_end(argList);
...
//                                       return execFuncParamsBlockWithKeyAndParams([blockDic objectForKey:@"__key"], tempArguments);
//                                   };
//                    blockInvocation = TTPatchUtils.TTPatchDynamicBlock(block,arguments);
////                    DynamicBlock(block, arguments);
//
//                    [invocation setArgument:&blockInvocation atIndex:(startIndex + i)];
...
//    .TTPATCH_hookClassMethod                      = HookClassMethod,
//    .TTPATCH_addPropertys                         = AddPropertys,
