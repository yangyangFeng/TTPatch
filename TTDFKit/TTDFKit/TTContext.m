...
- (void)configJSBrigeActions{
    ...
    self[kMessageQueue_oc_sendMsg] = ^(id obj,NSString *className , BOOL isSuper,BOOL isBlock,NSString* method,id arguments){
        return [TTDFEngine dynamicMethodInvocation:obj className:className isSuper:isSuper isBlock:isBlock method:MethodFormatterToOcFunc(method) arguments:arguments];
    };
