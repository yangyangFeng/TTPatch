...
defineClass('ViewController:UIViewController<UITableViewDelegate,UITableViewDataSource>', {
    ...
    tableView_didSelectRowAtIndexPath_: dynamic('@,@,@', function (tableview, indexPath) {
        if (indexPath.row() === 0) {
...
defineClass('BlockViewController:UITableViewController', {
    dealloc: function () {
        ...
        btnAction_: function (index) {
            ...
            case 0:
                {
                    self.testCall0_(block("void,void", function () {
            ...
            case 1:
                {
                    ...
                    self.callBlock_(function (arg) {
                        Utils.log_info('--------callBlock_---------   ' + arg);
                    });
                }
                break;
            case 2:
