 ...
 */
defineClass(
  "TTPlaygroundController:UIViewController",
  {
    /**
    ...
    funcWithParams_param2_param3_: dynamic(
      "void,NSString *,NSString *,NSString *",
      function (param1, param2, param3) {
        Utils.log_info(
          "[3]动态方法入参:" + param1 + "," + param2 + "," + param3
        );
      }
    ),
    ...
    addSomeTestView: function () {
      ...
      label.setFrame_(
        new TTReact(10, 64 + 20, self.view().bounds().size.width - 20, 80)
      );
      label.setText_(
      ...
      btn.setTitle_forState_("UIView.animateWithDuration_animations_", 0);
