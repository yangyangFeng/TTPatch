...
class Class_obj {
    ...
    __findMethod(method,isInstanceMethod){
        ...
        if (isInstanceMethod) {
            this.__methodCache.push({[method]:this.__methodList[method]});
            return this.__methodList[method];
        }else{
            this.__methodCache.push({[method]:this.__cls.__methodList[method]});
            return this.__cls.__methodList[method];
        }
    }
}
